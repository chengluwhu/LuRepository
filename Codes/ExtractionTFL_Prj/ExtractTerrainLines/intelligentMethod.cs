...
{
  public  class intelligentMethod
    {
        static public FeaPtInform feapt = new FeaPtInform();
        static double K = 0;
        ...
        static int isZearo = 0;         
        static public List<FeaPtInform> fptList = new List<FeaPtInform>();
